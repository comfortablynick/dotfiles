# Defined in /var/folders/gb/x1313fbd2klb5mss86_gsd1m0000gn/T//fish.6dFnKm/vcs_status.fish @ line 1
function vcs_status --description 'retrieve git repo info from vcprompt util'
	set -l repo ""
    set -l branch ""
    set -l revision ""
    set -l untracked ""
